<template>
  <div class="banner-1">
    ...
    >
      ...
      >
        ...
        <li class="menu-button"><a href="#work" v-smooth-scroll>Fitur</a></li>
        <li class="menu-button">
          <a href="#testimonial" v-smooth-scroll>Ulasan</a>
        </li>
        <li class="menu-button"><a href="#about" v-smooth-scroll>Tentang</a></li>
      </ul>
    </nav>
    <!-- End Navbar -->
    ...
    <div class="flex items-center">
      <div class="w-11/12 space-y-5 md:space-y-10">
        ...
        >
          ...
          >
            PawON SIGHT</a
          >🍳<br />Stock & Finance Management System
        </h1>

        <div class="md:flex gap-1 md:gap-10">
          <a href="/admin/login" class="text-white bg-gray-800 submit-button hidden md:block">
            Mulai kelola
          </a>
          <a href="https://wa.me/6285868548240" class="text-gray-800 border-4 border-gray-800 submit-button mb-5 md:mb-0">
            Contact Person
          </a>
</div>
      </div>
  ...
  <div class="banner-2 space-y-10 pb-20" id="work">
    <h3 class="heading3 my-5">Ada apa aja di PawON SIGHT? 🍳</h3>
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        <h4 class="project-title item">Dashboard Informatif </h4>
        <p class="font-work_sans pr-12">
            Dashboard informatif yang memberikan gambaran lengkap tentang kinerja bisnis Anda. Dengan visualisasi data yang mudah dipahami, Anda dapat memantau stok, keuangan, dan aktivitas lainnya secara real-time.
        </p>
        <br>
        <a href="/admin" class="text-sky-800 font-bold text-2xl tracking-wider">
          Lihat langsung  
        </a>
      </div>
      <div class="card-image bg-white-50">
        <img
    ...
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        <h4 class="project-title item">Kelola Stok & Keuangan </h4>
        <p class="font-work_sans pr-12">
            Kelola stok dan keuangan dengan mudah di PawON SIGHT. Dengan fitur yang lengkap, Anda dapat memantau stok barang, melakukan transaksi keuangan, dan melacak transaksi secara real-time.
        </p>
        <br>
        <a href="/admin" class="text-sky-800 font-bold text-2xl tracking-wider">
          Lihat langsung  
    ...
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        <h4 class="project-title item">Notifikasi </h4>
        <p class="font-work_sans pr-12">
            Dapatkan notifikasi real-time tentang stok barang, transaksi, dan aktivitas lainnya. Dengan notifikasi yang akurat, Anda tidak akan ketinggalan informasi penting.
        </p>
        <br>
        <a href="/admin" class="text-sky-800 font-bold text-2xl tracking-wider">
          Lihat langsung  
  ...
  <div class="banner-1" id="testimonial">
    <div class="space-y-4 grid place-items-center mt-5">
      ...
      <p class="font-DM_Sans text-gray-600 font-semibold leading-relaxed">
        ...
        <div class="relative lg:flex rounded-lg shadow-2xl overflow-hidden">
          ...
          <div class="relative lg:w-7/12 bg-white">
            ...
            >
              <p>
                PawON SIGHT
                <strong class="text-gray-900 font-medium">telah menjadi game changer</strong> bagi bisnis kami. PawON SIGHT telah meringkaskan proses manajemen stok dan keuangan kami, membuat operasi kami lebih efisien dan terukur. Notifikasi real-time dan dashboard yang ramah pengguna telah secara signifikan meningkatkan alur kerja kami.
              </p>
              <p class="mt-6">
                <a
                  href="#"
  ...
  <div class="banner-2 md:flex items-center md:justify-evenly" id="about">
    ...
    />
    <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
      <h4 class="project-title item">PawON SIGHT States</h4>
      <p class="font-work_sans">
        PawON SIGHT adalah sistem manajemen stok dan keuangan yang dirancang untuk membantu bisnis Anda berjalan lebih efisien. Dengan fitur-fitur seperti dashboard informatif, pengelolaan stok dan keuangan, serta notifikasi real-time, PawON SIGHT memberikan solusi lengkap untuk kebutuhan manajemen bisnis Anda. Sistem ini memungkinkan Anda untuk memantau kinerja bisnis secara real-time, melakukan transaksi dengan mudah, dan mendapatkan notifikasi penting tepat waktu. Dengan PawON SIGHT, Anda dapat fokus pada pengembangan bisnis Anda tanpa khawatir tentang manajemen stok dan keuangan.
      </p>
